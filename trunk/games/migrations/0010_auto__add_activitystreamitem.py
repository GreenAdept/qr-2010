...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ActivityStreamItem'
        db.create_table('games_activitystreamitem', (
            ...
            ('target', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Game'])),
            ('occurred', self.gf('django.db.models.fields.DateTimeField')(default='2010-01-01')),
        ))
        db.send_create_signal('games', ['ActivityStreamItem'])


    def backwards(self, orm):
        
        # Deleting model 'ActivityStreamItem'
        db.delete_table('games_activitystreamitem')
    ...
    models = {
        ...
        'games.activitystreamitem': {
            'Meta': {'object_name': 'ActivityStreamItem'},
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'occurred': ('django.db.models.fields.DateTimeField', [], {'default': "'2010-01-01'"}),
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['games.Game']"}),
        ...
        'games.game': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_games.game_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'template_directory': ('django.db.models.fields.FilePathField', [], {'path': "'/home/rob/workspace/game_template_dir/'", 'max_length': '100', 'recursive': 'True', 'blank': 'True'})
        },
        'games.location': {
            ...
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_games.location_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
            'uuid': ('qr.thirdparty.uuidfield.fields.UUIDField', [], {'unique': 'True', 'max_length': '32', 'blank': 'True'}),
        ...
        'games.player': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'polymorphic_ctype': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'polymorphic_games.player_set'", 'null': 'True', 'to': "orm['contenttypes.ContentType']"}),
