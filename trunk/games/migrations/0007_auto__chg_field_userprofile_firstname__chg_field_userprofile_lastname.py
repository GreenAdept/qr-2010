...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.firstname'
        db.alter_column('games_userprofile', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'UserProfile.lastname'
        db.alter_column('games_userprofile', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'UserProfile.firstname'
        db.alter_column('games_userprofile', 'firstname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'UserProfile.lastname'
        db.alter_column('games_userprofile', 'lastname', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
