...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('games_userprofile', 'thumbnail')

        # Adding field 'UserProfile.gender'
        db.add_column('games_userprofile', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)

        # Adding field 'UserProfile.birthday'
        db.add_column('games_userprofile', 'birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'UserProfile.bio'
        db.add_column('games_userprofile', 'bio', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'UserProfile.thumbnail'
        db.add_column('games_userprofile', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'UserProfile.gender'
        db.delete_column('games_userprofile', 'gender')

        # Deleting field 'UserProfile.birthday'
        db.delete_column('games_userprofile', 'birthday')

        # Deleting field 'UserProfile.bio'
        db.delete_column('games_userprofile', 'bio')
