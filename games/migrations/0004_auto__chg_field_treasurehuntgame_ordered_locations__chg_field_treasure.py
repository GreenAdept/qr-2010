...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TreasureHuntGame.ordered_locations'
        db.alter_column('games_treasurehuntgame', 'ordered_locations', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=200))

        # Changing field 'TreasureHuntPlayer.highest_visited'
        db.alter_column('games_treasurehuntplayer', 'highest_visited_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['games.Location']))


    def backwards(self, orm):
        
        # Changing field 'TreasureHuntGame.ordered_locations'
        db.alter_column('games_treasurehuntgame', 'ordered_locations', self.gf('django.db.models.fields.CommaSeparatedIntegerField')(max_length=100))

        # Changing field 'TreasureHuntPlayer.highest_visited'
        db.alter_column('games_treasurehuntplayer', 'highest_visited_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['games.Location']))
